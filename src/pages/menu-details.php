        ...
        <div class="flex-grow flex flex-col px-20 max-md:px-6 max-sm:px-2 py-6 gap-3">
            ...
            <div class="bg-gray-100 rounded-lg flex flex-col p-2 gap-2">
                ...
                while($all_plats->fetch()){
                    ...
                    <img class='h-full' src='../../src/assets/images/plats/$plat_picture' alt=''>
                ...
                <?php
                echo "<form method='post' action='./process/make-reservation.php?menu_id=$menu_id' class='flex justify-end mt-2'>
